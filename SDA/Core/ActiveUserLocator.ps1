<#
.SYNOPSIS
    SDA Web-Ready Core: ActiveUserLocator.ps1
.DESCRIPTION
...
Write-Output "========================================"
Write-Output "[SDA] ACTIVE USER LOCATOR"
Write-Output "========================================"
