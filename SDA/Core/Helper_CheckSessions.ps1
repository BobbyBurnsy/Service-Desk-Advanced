<#
.SYNOPSIS
    SDA Web-Ready Core: Helper_CheckSessions.ps1
.DESCRIPTION
...
Write-Output "========================================"
Write-Output "[SDA] SESSION CHECK: $Target"
Write-Output "========================================"
