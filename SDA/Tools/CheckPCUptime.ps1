...
# --- Main Execution ---
Write-Output "========================================"
Write-Output "[SDA] SYSTEM UPTIME VERIFICATION"
Write-Output "========================================"
...
if (-not [string]::IsNullOrWhiteSpace($RawBootString)) {
    try {
        ...
        Write-Output "`n[SDA SUCCESS] Uptime retrieved successfully via $MethodUsed!"
