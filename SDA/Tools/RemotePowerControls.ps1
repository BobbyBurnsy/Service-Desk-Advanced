<#
.SYNOPSIS
    SDA Web-Ready Tool: RemotePowerControls.ps1
.DESCRIPTION
...
# --- Main Execution ---
Write-Output "========================================"
Write-Output "[SDA] REMOTE POWER CONTROLS"
Write-Output "========================================"
...
try {
    ...
    Write-Output "`n[SDA SUCCESS] Power action '$PowerAction' dispatched successfully via WinRM!"
    ...
    if (Test-Path $psExecPath) {
        try {
            ...
            if ($Process.ExitCode -eq 0) {
                Write-Output "`n[SDA SUCCESS] Power action '$PowerAction' dispatched successfully via PsExec!"
