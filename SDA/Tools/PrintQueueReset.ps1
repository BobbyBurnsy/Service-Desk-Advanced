<#
.SYNOPSIS
    SDA Web-Ready Tool: PrintQueueReset.ps1
.DESCRIPTION
...
# --- Main Execution ---
Write-Output "========================================"
Write-Output "[SDA] PRINT QUEUE RESET"
Write-Output "========================================"
...
try {
    ...
    Write-Output "`n[SDA SUCCESS] Print Spooler restarted and print queue cleared via WinRM!"
    ...
    if (Test-Path $psExecPath) {
        try {
            ...
            if ($Process.ExitCode -eq 0) {
                Write-Output "`n[SDA SUCCESS] Print Spooler restarted and print queue cleared via PsExec!"
