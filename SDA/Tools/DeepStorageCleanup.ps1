...
# --- Main Execution ---
Write-Output "========================================"
Write-Output "[SDA] DEEP STORAGE CLEANUP"
Write-Output "========================================"
...
if ($RawOutputString -match '---JSON_START---(.*?)---JSON_END---') {
    try {
        ...
        Write-Output "`n[SDA SUCCESS] Deep Storage Cleanup completed via $MethodUsed!"
