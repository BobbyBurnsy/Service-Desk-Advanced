<#
.SYNOPSIS
    SDA Web-Ready Tool: DNSNetworkRefresh.ps1
.DESCRIPTION
...
# --- Main Execution ---
Write-Output "========================================"
Write-Output "[SDA] DNS & NETWORK REFRESH"
Write-Output "========================================"
...
try {
    ...
    Write-Output "`n[SDA SUCCESS] DNS/WINS refresh commands dispatched via WinRM."
    ...
    if (Test-Path $psExecPath) {
        try {
            ...
            if ($Process.ExitCode -eq 0) {
                Write-Output "`n[SDA SUCCESS] DNS/WINS refresh commands dispatched via PsExec."
                Write-Output "             (Note: It may take 5-10 minutes for the Domain Controller to update)"
