...
# --- Main Execution ---
Write-Output "========================================"
Write-Output "[SDA] BACKGROUND POLICY ENFORCEMENT"
Write-Output "========================================"
...
try {
    ...
    Write-Output "`n[SDA SUCCESS] Policy enforcement triggered successfully via WinRM!"
    ...
    if (Test-Path $psExecPath) {
        try {
            ...
            if ($Process.ExitCode -eq 0) {
                Write-Output "`n[SDA SUCCESS] Policy enforcement triggered successfully via PsExec!"
