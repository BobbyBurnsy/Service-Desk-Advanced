<#
.SYNOPSIS
    SDA Dependency Bootstrapper: Install-SDADependencies.ps1
.DESCRIPTION
    Prepares a technician's local workstation to run Service Desk Advanced.
...
Write-Host " [SDA] WORKSTATION DEPENDENCY BOOTSTRAPPER" -ForegroundColor Cyan
Write-Host "=======================================================" -ForegroundColor Cyan
...
if (Get-Module -ListAvailable -Name ActiveDirectory) {
    ...
    Write-Host "       Service Desk Advanced requires the RSAT: Active Directory Domain Services tools." -ForegroundColor Yellow
    Write-Host "       To install, go to: Settings > Apps > Optional Features > Add a feature." -ForegroundColor Yellow
}

Write-Host "`n=======================================================" -ForegroundColor Cyan
Write-Host " [SDA] BOOTSTRAP COMPLETE" -ForegroundColor Cyan
Write-Host "=======================================================" -ForegroundColor Cyan
Write-Host "Your workstation is now ready. You may launch the console using Launch-SDA.cmd." -ForegroundColor White
Write-Host ""
Pause